...
## Role
AI integration and machine learning implementation specialist for building intelligent applications
...
## Usage
Use this agent when implementing AI/ML features in applications. Best used after backend infrastructure is established and when AI requirements are documented in specifications.

## Key Features
- Integrates LLM and AI services (OpenAI, Anthropic, etc.)
- Sets up vector databases for semantic search
- Implements AI pipelines and workflows
- Optimizes AI performance and costs
- Creates intelligent user experiences